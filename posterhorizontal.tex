...
\title{Clustering the past: the use of multivariate analysis to understand cultural dynamics} % Poster title

\author{Maria Coto-Sarmiento, Xavier Rubio-Campillo and Jos\'e Remesal} % Author(s)
...
\begin{figure}
\includegraphics[width=0.1\linewidth]{qrplanet.png}
\end{figure}
\begin{center}
\item \href{mailto:maria.coto@bsc.es}{maria.coto@bsc.es}
\end{center}
